...
<!-- ```{r} -->
<!-- fldr = "../02_CrabpackDataComparisons"; -->
<!-- child_path$push(file.path(child_path$peek(),fldr)); -->
<!-- ``` -->
<!-- ```{r sct_CrabPack, child=file.path(child_path$peek(),"q00_PIBKC_CrabpackDataComparisons.qmd")} -->
<!-- ``` -->
<!-- ```{r} -->
<!-- child_path$pop(); -->
<!-- ``` -->
...
<!-- # No corner stations {#sec-NoCorners} -->

<!-- ```{r sct_NoCorners, child=file.path(child_path$peek(),"../03_NoCornerStations/q00_PIBKC _NoCornerStations.qmd")} -->
<!-- ``` -->


<!-- # Sampling-based zeros substitution {#sec-SubstZeros} -->

```{r}
fldr = "../04_SamplingBasedZerosSubstitutions";
child_path$push(file.path(child_path$peek(),fldr));
```
```{r sct_SubstZeros, child=file.path(child_path$peek(),"q00_SamplingBasedZerosSubstitutions.qmd")}
```
```{r}
child_path$pop();
```
...
<!-- # sdmTMB for zeros substitution {#sec-SubstZeros} -->

<!-- ```{r sct_sdmTMB, child=file.path(child_path$peek(),"../05_sdmTMB/q00_sdmTMBforZeroSubstitutions.qmd")} -->
<!-- ``` -->
